...
>(({ className, ...props }, ref) => (
  <CommandPrimitive
    ref={ref}
    className={cn(
      `flex h-full w-full flex-col overflow-hidden rounded-md bg-foreground
      text-text-primary`,
      className,
    )}
    {...props}
...
>(({ className, ...props }, ref) => (
  <CommandPrimitive.Group
    ref={ref}
    className={cn(
      `[&_[cmdk-group-heading]]:text-muted-foreground text-text-proimary
...
>(({ className, ...props }, ref) => (
  <CommandPrimitive.Item
    ...
    className={cn(
      ...
      text-sm outline-none hover:bg-foreground-hover
